...
import ScreenUtil from '../../Core/utils/ScreenUtil';


let ins_top = Platform.select({
    ios: ScreenUtil.getOffset(),
    android: 40,
});
export default class PageView extends Component {
    ...
    constructor (props) {
        ...
        if(props.ins_top){
            ...
            ins_top = this.props.ins_top;
        }else if(props.ins_top===0){
    ...
    render() {
        return (
            <View style={[styles.mainStyle,{marginTop:this.props.hiddenNav?0:ins_top,}]}>
